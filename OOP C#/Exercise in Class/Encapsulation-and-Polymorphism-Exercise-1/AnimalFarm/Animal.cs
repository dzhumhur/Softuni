    ...
    public abstract class Animal
    {
        ...
        public string Name
        {
            ...
            private set
            {
                ...
                {
                    throw new Exception("Name cannot be null, empty or whitespaces");
                }
        ...
        public int Age
        {
            ...
            private set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("value", "Age should be in range [" + MinAnimalAge + "..." + MaxAnimalAge + "]");
                }
            }
        }
